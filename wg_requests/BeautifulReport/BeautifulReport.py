...
SITE_PAKAGE_PATH = r"E:\work_soft\PyCharm\PyCharm Community Edition 2017.2.4\project\wangguan\wg_requests\BeautifulReport\template\template"
...
class PATH:
    """ all file PATH meta """
    config_tmp_path =SITE_PAKAGE_PATH
